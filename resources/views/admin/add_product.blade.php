    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Thêm sản phẩm</h3>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                        <center class="card-title mt-2">Thêm Sản Phẩm</center>
                        <form class="form-horizontal form-material mx-2" action="{{URL::to('/save-product')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <center><button type="submit" class="btn btn-success mx-auto mx-md-0 text-white" name="add-product">Thêm Sản Phẩm</button></center>
                        </form>
                    </div>
                </div>
            </div>
